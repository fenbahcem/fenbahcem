class Admin::MateryalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_materyal.save
        format.html { redirect_to @admin_materyal, notice: 'Materyal was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @admin_materyal.update(admin_materyal_params)
        format.html { redirect_to @admin_materyal, notice: 'Materyal was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_materyals_url, notice: 'Materyal was successfully destroyed.' }
  ...
  private
    ...
    def admin_materyal_params
      params.require(:admin_materyal).permit(:sinif, :uniteadi, :materyaltur, :materyaladi, :materyalaciklama)
    end
end
