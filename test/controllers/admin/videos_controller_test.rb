...
class Admin::VideosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_video" do
    assert_difference('Admin::Video.count') do
      post admin_videos_url, params: { admin_video: { baslik: @admin_video.baslik, tur: @admin_video.tur, videolink: @admin_video.videolink } }
    end
  ...
  test "should update admin_video" do
    patch admin_video_url(@admin_video), params: { admin_video: { baslik: @admin_video.baslik, tur: @admin_video.tur, videolink: @admin_video.videolink } }
